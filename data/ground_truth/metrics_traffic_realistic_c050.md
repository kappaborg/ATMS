# Field metrics — traffic_realistic_c050
...
| toyota | (no commit) | 24 |
| ford | (no commit) | 18 |
| volkswagen | (no commit) | 17 |
| vauxhall | (no commit) | 14 |
| bmw | (no commit) | 12 |
| mercedes-benz | (no commit) | 12 |
| nissan | (no commit) | 12 |
| citroen | (no commit) | 11 |
| daihatsu | (no commit) | 10 |
| audi | (no commit) | 9 |
| isuzu | (no commit) | 7 |
| renault | (no commit) | 6 |
| suzuki | (no commit) | 4 |
