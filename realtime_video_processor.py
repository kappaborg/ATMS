...
services/video-processor/tools/realtime_video_processor.py (gap H3).
...
sys.stderr.write(
    "NOTE: realtime_video_processor.py moved to "
    "services/video-processor/tools/ — update your invocation.\n"
)
runpy.run_path(
    str(Path(__file__).resolve().parent / "services/video-processor/tools/realtime_video_processor.py"),
    run_name="__main__",
)
